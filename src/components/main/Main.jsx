        ...
        >
            <div className=" md:w-4/5 flex justify-center gap-4 items-center mb-20">
                <img
                    ...
                    className="w-32 h-32 md:w-60 md:h-60 -rotate-12 hover:rotate-12 transition-transform duration-500 ease-in-out border-2 border-green-500 rounded-full shadow-2xl"
